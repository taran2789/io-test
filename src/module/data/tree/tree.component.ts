...
*/
import {
  AfterViewInit, ChangeDetectionStrategy, ChangeDetectorRef, Component, ContentChild, ElementRef, EventEmitter,
  HostListener, Input, OnInit, Output, TemplateRef,
} from '@angular/core';
...
*/
  ...
  */
  ...
  onNodeClick(node: any) {
   ...
   // this.activateNode(this._data, node);
  }
  ...
  setData(httpResponse: any) {
    ...
    this.parentRef = this._data;
    this.setSelectedFlag();
    this.activateNode(this._data, null);
  }
  ...
  emitCheckedData(checkedData: any) {
    ...
    if (checkedData.checked) {
      ...
      this.onTreeNodeChecked.emit(this._data);
    } else {
      if (checkedData.hasOwnProperty(this.childarraykey)) {
        checkedData[this.childarraykey].forEach((option: any) => {
